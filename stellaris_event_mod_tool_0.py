...
def create_output(tech_data: List) -> Dict[str, str]:
  ...
  event_id = 25   # 使っていないイベントIDに割り当てる（バニラは24まで使用済み）
  for area in areas:
    area_output = ""
...
def main():
  file_path = "./Modtechnology/output.xlsx"   # 収集された他Modの技術をまとめたエクセルを選択
